...
for i in $(seq 0 1 9); do
  ...
  python network_training.py --dataset ${dataset} --results-path ${path}  --RP-emb-dim 152 --FS-emb-dim 152 --patience 15 --dist-url tcp://127.0.0.1:6666 --dist-backend nccl --gpu 0 --world-size 1 --rank 0 -b 100 --network Dual_CA_Softmax
done