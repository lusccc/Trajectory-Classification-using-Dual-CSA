cd ..
results_path=./results/test_torch
...
#python network_training.py --dataset SHL --results_path ./results/test_torch --alpha 1 --beta 8 --gamma 1 --RP_emb_dim 152 --FS_emb_dim 152 --dist-url tcp://127.0.0.1:6666 --dist-backend nccl --multiprocessing-distributed --world-size 1 --rank 0
#python network_training.py --dataset SHL --results_path ${results_path} --alpha 1 --beta 8 --gamma 1 --RP_emb_dim 152 --FS_emb_dim 152 --dist-url tcp://127.0.0.1:6666 --dist-backend nccl --multiprocessing-distributed --world-size 1 --rank 0
