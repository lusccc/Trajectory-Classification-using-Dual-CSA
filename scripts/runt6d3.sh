...
python ./MF_RP_mat.py --dim 3 --tau 6 --trjs_segs_features_path ./data/geolife_features/trjs_segs_features_train.npy --save_path ./data/geolife_features/RP_mats_train.npy
python ./MF_RP_mat.py --dim 3 --tau 6 --trjs_segs_features_path ./data/geolife_features/trjs_segs_features_test.npy --save_path ./data/geolife_features/RP_mats_test.npy
