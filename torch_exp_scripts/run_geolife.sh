...
python ./PEDCC.py --features_path ./data/geolife_features/multi_feature_segs_train.npy --save_dir ./data/geolife_features --dim 304
python ./PEDCC.py --features_path ./data/geolife_features/multi_feature_segs_test.npy --save_dir ./data/geolife_features --dim 304
python network_training.py --dataset geolife --results_path ./results/test_torch --alpha 1 --beta 8 --gamma 1 --RP_emb_dim 152 --FS_emb_dim 152 --dist-url 'tcp://127.0.0.1:6666' --dist-backend nccl --multiprocessing-distributed --world-size 1 --rank 0
