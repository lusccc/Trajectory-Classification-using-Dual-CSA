...
res_path = 'C:/Users/lsc/Desktop/exps_results/SHL_lstm_fcn_softmax_keras_exps'
total_accs = []
for i in range(10):
    exp_path = os.path.join(res_path, f'SHL_lstm_fcn_softmax_exp{i}')
...
print(mean_acc) #0.8014789999999999