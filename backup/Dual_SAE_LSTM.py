...
if __name__ == '__main__':
    x_RP_mf_ori_train, x_RP_mf_ori_test, \
    x_RP_mf_filtered_train, x_RP_mf_filtered_test, \
    x_trj_seg_of_ori_train, x_trj_seg_of_ori_test, \
    x_trj_seg_of_filtered_train, x_trj_seg_of_filtered_test, \
